...
This is a sample Chat App demonstrates the use of  EnableX (https://www.enablex.io/cpaas/) platform Server APIs and iOS Toolkit to build iOS chat application. It allows developers to ramp up on app development by hosting on their own devices. 
